...
— TEZ has a little impact on execution speed when used with a file in TEXTFORMAT format, but shows tremendous performance gains with AVRO (up to 2 times), RCFILE/ORC (up to 20 times faster) and PARQUET (2-5 times faster)  
