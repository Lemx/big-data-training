...
hdfs dfs -rm -r /big-data-training/hive/lab4
hdfs dfs -mkdir -p /big-data-training/hive/lab4 && \
hdfs dfs -put *.csv /big-data-training/hive/lab4 && \

mvn clean && \
mvn package \
java -jar target/tab4.jar